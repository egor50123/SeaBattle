...
export const useSetShipCoordinates = (id) => {
  ...
  function dispatchShipCoordinates() {
    switch (id) {
      case 1:
        if (shipData1.shipSquares) dispatch(setShipCoordinates(1, shipData1.shipSquares[0]));
        break;
      case 2:
        if (shipData2.shipSquares) dispatch(setShipCoordinates(2, shipData2.shipSquares[0]));
        break;
      case 3:
        if (shipData3.shipSquares) dispatch(setShipCoordinates(3, shipData3.shipSquares[0]));
        break;
      case 4:
        if (shipData4.shipSquares) dispatch(setShipCoordinates(4, shipData4.shipSquares[0]));
        break;
      case 5:
        if (shipData5.shipSquares) dispatch(setShipCoordinates(5, shipData5.shipSquares[0]));
        break;
      case 6:
        if (shipData6.shipSquares) dispatch(setShipCoordinates(6, shipData6.shipSquares[0]));
        break;
      case 7:
        if (shipData7.shipSquares) dispatch(setShipCoordinates(7, shipData7.shipSquares[0]));
        break;
      case 8:
        if (shipData8.shipSquares) dispatch(setShipCoordinates(8, shipData8.shipSquares[0]));
        break;
      case 9:
        if (shipData9.shipSquares) dispatch(setShipCoordinates(9, shipData9.shipSquares[0]));
        break;
      case 10:
        if (shipData10.shipSquares) dispatch(setShipCoordinates(10, shipData10.shipSquares[0]));
        break;
      default:
        break;
    }
